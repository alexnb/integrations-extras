...
class Neo4jCheck(PrometheusCheck):
    ...
    COUNTER_METRICS = {
        'neo4j_database_neo4j_check_point_events_total',
        'neo4j_database_neo4j_check_point_total_time_total',
        'neo4j_database_neo4j_cluster_catchup_tx_pull_requests_received_total',
        'neo4j_database_neo4j_cypher_replan_events_total',
        'neo4j_database_neo4j_cypher_replan_wait_time_total',
        'neo4j_database_neo4j_db_query_execution_failure_total',
        'neo4j_database_neo4j_db_query_execution_success_total',
        'neo4j_database_neo4j_log_appended_bytes_total',
        'neo4j_database_neo4j_log_flushes_total',
        'neo4j_database_neo4j_log_rotation_events_total',
        'neo4j_database_neo4j_log_rotation_total_time_total',
        'neo4j_database_neo4j_transaction_committed_read_total',
        'neo4j_database_neo4j_transaction_committed_total',
        'neo4j_database_neo4j_transaction_committed_write_total',
        'neo4j_database_neo4j_transaction_last_closed_tx_id_total',
        'neo4j_database_neo4j_transaction_last_committed_tx_id_total',
        'neo4j_database_neo4j_transaction_peak_concurrent_total',
        'neo4j_database_neo4j_transaction_rollbacks_read_total',
        'neo4j_database_neo4j_transaction_rollbacks_total',
        'neo4j_database_neo4j_transaction_rollbacks_write_total',
        'neo4j_database_neo4j_transaction_started_total',
        'neo4j_database_neo4j_transaction_terminated_read_total',
        'neo4j_database_neo4j_transaction_terminated_total',
        'neo4j_database_neo4j_transaction_terminated_write_total',
        'neo4j_database_system_check_point_events_total',
        'neo4j_database_system_check_point_total_time_total',
        'neo4j_database_system_cluster_catchup_tx_pull_requests_received_total',
        'neo4j_database_system_cypher_replan_events_total',
        'neo4j_database_system_cypher_replan_wait_time_total',
        'neo4j_database_system_db_query_execution_failure_total',
        'neo4j_database_system_db_query_execution_success_total',
        'neo4j_database_system_log_appended_bytes_total',
        'neo4j_database_system_log_flushes_total',
        'neo4j_database_system_log_rotation_events_total',
        'neo4j_database_system_log_rotation_total_time_total',
        'neo4j_database_system_transaction_committed_read_total',
        'neo4j_database_system_transaction_committed_total',
        'neo4j_database_system_transaction_committed_write_total',
        'neo4j_database_system_transaction_last_closed_tx_id_total',
        'neo4j_database_system_transaction_last_committed_tx_id_total',
        'neo4j_database_system_transaction_peak_concurrent_total',
        'neo4j_database_system_transaction_rollbacks_read_total',
        'neo4j_database_system_transaction_rollbacks_total',
        'neo4j_database_system_transaction_rollbacks_write_total',
        'neo4j_database_system_transaction_started_total',
        'neo4j_database_system_transaction_terminated_read_total',
        'neo4j_database_system_transaction_terminated_total',
        'neo4j_database_system_transaction_terminated_write_total',
        'neo4j_dbms_bolt_accumulated_processing_time_total',
        'neo4j_dbms_bolt_accumulated_queue_time_total',
        'neo4j_dbms_bolt_connections_closed_total',
        'neo4j_dbms_bolt_connections_opened_total',
        'neo4j_dbms_bolt_messages_done_total',
        'neo4j_dbms_bolt_messages_failed_total',
        'neo4j_dbms_bolt_messages_received_total',
        'neo4j_dbms_bolt_messages_started_total',
        'neo4j_dbms_bolt_response_failed_total',
        'neo4j_dbms_bolt_response_ignored_total',
        'neo4j_dbms_bolt_response_success_total',
        'neo4j_dbms_db_operation_count_create_total',
        'neo4j_dbms_db_operation_count_drop_total',
        'neo4j_dbms_db_operation_count_failed_total',
        'neo4j_dbms_db_operation_count_recovered_total',
        'neo4j_dbms_db_operation_count_start_total',
        'neo4j_dbms_db_operation_count_stop_total',
        'neo4j_dbms_page_cache_bytes_read_total',
        'neo4j_dbms_page_cache_bytes_written_total',
        'neo4j_dbms_page_cache_eviction_exceptions_total',
        'neo4j_dbms_page_cache_evictions_cooperative_total',
        'neo4j_dbms_page_cache_evictions_total',
        'neo4j_dbms_page_cache_flushes_total',
        'neo4j_dbms_page_cache_hits_total',
        'neo4j_dbms_page_cache_iops_total',
        'neo4j_dbms_page_cache_merges_total',
        'neo4j_dbms_page_cache_page_cancelled_faults_total',
        'neo4j_dbms_page_cache_page_fault_failures_total',
        'neo4j_dbms_page_cache_page_faults_total',
        'neo4j_dbms_page_cache_page_no_pin_page_faults_total',
        'neo4j_dbms_page_cache_pages_copied_total',
        'neo4j_dbms_page_cache_page_vectored_faults_failures_total',
        'neo4j_dbms_page_cache_page_vectored_faults_total',
        'neo4j_dbms_page_cache_pins_total',
        'neo4j_dbms_page_cache_throttled_millis_total',
        'neo4j_dbms_page_cache_throttled_times_total',
        'neo4j_dbms_page_cache_unpins_total',
        'neo4j_dbms_vm_gc_count_g1_old_generation_total',
    ...
    def _check_namespaced_metrics(self, metrics, config, meta_map):
        for metric in metrics:
            ...
            print("received metric" + metric + " monotonic " + send_monotonic_counter)
