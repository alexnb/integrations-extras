...
class Neo4jCheck(PrometheusCheck):
    ...
    def _check_namespaced_metrics(self, metrics, config, meta_map):
        for metric in metrics:
            ...
            send_monotonic_counter = Neo4jCheck.is_counter_metric(metric.name)
    ...
    def is_counter_metric(metric_name):
        for suffix in Neo4jCheck.get_counter_metric_suffixes():
    ...
    def get_allowlisted_metrics():
        return {
            ...
            'page_cache_evictions_total': 'page_cache.evictions.tmp2',
